$packageName = 'MakeMKV'
$installerType = 'EXE' 
$url = 'http://www.makemkv.com/download/Setup_MakeMKV_v1.9.8.exe' # download url
$url64 = 'http://www.makemkv.com/download/Setup_MakeMKV_v1.9.8.exe' # 64bit URL uses the same as $url
